...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='课程表：存储健身房提供的课程信息及对应教练';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='员工表：存储健身房员工信息，包括教练、前台和管理员';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员表：存储健身房会员的基本信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员卡表：存储会员的会籍卡信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `membership_card` VALUES (1,1,2,'2024-01-10','2025-01-09','expired'),(2,2,1,'2024-11-15','2024-12-14','expired'),(3,3,2,'2024-03-05','2025-03-04','expired'),(4,4,1,'2024-11-12','2024-12-11','expired'),(5,5,2,'2024-05-20','2025-05-19','expired'),(6,6,1,'2024-11-08','2024-12-07','expired'),(7,7,2,'2024-07-15','2025-07-14','expired'),(8,8,1,'2024-08-01','2024-08-31','expired'),(9,9,1,'2024-11-10','2024-12-09','expired'),(10,10,2,'2024-10-05','2025-10-04','expired');
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单表：存储所有类型的订单信息（会员卡、产品、课程）';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='产品表：存储健身房销售的产品信息及库存';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'admin','jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=','employee',14,'active','2025-12-08 16:53:08','2025-12-08 16:55:33','2025-12-08 16:55:33'),(2,'trainer','jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=','employee',15,'active','2025-12-08 16:53:08','2025-12-08 16:53:08',NULL);
...
-- Dump completed on 2025-12-09  0:56:37
